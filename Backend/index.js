...
app.post("/api/auth/send-otp", async (req, res) => {
  ...
  try {
    ...
    const emailSubject = "Your LetiMail Verification Code";

    // Use console.log for testing if SendGrid isn't working
    console.log(`Sending OTP email to ${email}: ${otp}`);

    // Uncomment this when SendGrid is properly configured
    /*
